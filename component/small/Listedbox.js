...
import { locationContext } from "../filters/states";
...
function Listedbox({ location }) {
  const { selected, setSelected } = useContext(locationContext);
  return (
      ...
      {({ open }) => (
        <>
          ...
          <div className="mt-1 relative">
            <Listbox.Button className="relative bg-white rounded-md  shadow-md pl-3 pr-10 py-2 text-left cursor-default focus:outline-none sm:text-sm w-40">
